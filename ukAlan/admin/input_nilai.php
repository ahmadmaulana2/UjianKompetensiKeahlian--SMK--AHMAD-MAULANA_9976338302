...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO nilai (NISN, Kode_guru, Kode_sk, Nilai_angka, Nilai_huruf) VALUES (%s, %s, %s, %s, %s)",
...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">INPUT DATA NILAI</div></h1>
        <div align="center"><form action="<?php echo $editFormAction; ?>" method="post" id="form1" enctype="multipart/form-data" name="form1">
          <table border="23" align="center" cellpadding="5" cellspacing="5">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="Kode_sk" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
