...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO standar_kompetensi (Kode_sk, Kode_kk, Nama_sk, Kelas_sk) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_koneksi, $koneksi);
$query_sk = sprintf("SELECT * FROM standar_kompetensi WHERE Kode_sk = %s", GetSQLValueString($colname_sk, "char"));
...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">INPUT DATA STANDAR KOMPETENSI</div></h1>
        <div align="center"><form action="<?php echo $editFormAction; ?>" method="post" id="form1" enctype="multipart/form-data" name="form1">
          <table border="23" align="center" cellpadding="5" cellspacing="5">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="Nama_sk" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right"><strong>Kelas SK :</strong></td>
              <td><input type="text" name="Kelas_sk" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">&nbsp;</td>
