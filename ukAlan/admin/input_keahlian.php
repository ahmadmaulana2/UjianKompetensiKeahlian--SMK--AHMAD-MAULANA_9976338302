...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO kompetensi_keahlian (Kode_kk, Kode_mata_diklat, Nama_kompetensi_keahlian) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['Kode_kk'], "char"),
                       GetSQLValueString($_POST['Kode_mata_diklat'], "char"),
...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">INPUT DATA KOMPETENSI KEAHLIAN</div></h1>
        <div align="center"><form action="<?php echo $editFormAction; ?>" method="post" id="form1" enctype="multipart/form-data" name="form1">
          <table border="23" align="center" cellpadding="5" cellspacing="5">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="Kode_mata_diklat" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right"><strong>Nama KK:</strong></td>
              <td><input type="text" name="Nama_kompetensi_keahlian" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">&nbsp;</td>
