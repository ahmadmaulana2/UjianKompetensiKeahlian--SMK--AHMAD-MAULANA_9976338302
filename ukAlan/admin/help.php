...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">INFORMATION</div></h1>
        <h1><p><strong>Website ini dibuat oleh Ahmad Maulana XII - RPL siswa SMK Raflesia yang sedang mengikuti Ujian Kompetensi Kejuruan (UKK).</strong></p></h1>
