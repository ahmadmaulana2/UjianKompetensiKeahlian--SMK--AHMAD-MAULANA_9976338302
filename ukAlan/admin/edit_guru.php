...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE guru SET Kode_kk=%s, Nama_guru=%s, NIP=%s, Alamat_guru=%s, Telp_guru=%s WHERE Kode_guru=%s",
                       GetSQLValueString($_POST['Kode_kk'], "char"),
                       GetSQLValueString($_POST['Nama_guru'], "text"),
                       GetSQLValueString($_POST['NIP'], "char"),
                       GetSQLValueString($_POST['Alamat_guru'], "text"),
                       GetSQLValueString($_POST['Telp_guru'], "text"),
                       GetSQLValueString($_POST['Kode_guru'], "char"));
...
mysql_select_db($database_koneksi, $koneksi);
$query_guru = sprintf("SELECT * FROM guru WHERE Kode_guru = %s", GetSQLValueString($colname_guru, "char"));
...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">EDIT DATA GURU</div></h1>
       <div align="center"><form action="<?php echo $editFormAction; ?>" method="post" id="form1" enctype="multipart/form-data" name="form1">
          <table border="23" align="center" cellpadding="5" cellspacing="5">
            <tr valign="baseline">
              <td align="right">Kode_guru:</td>
              <td><?php echo $row_guru['Kode_guru']; ?></td>
            </tr>
            <tr valign="baseline">
              <td align="right">Kode_kk:</td>
              <td><input type="text" name="Kode_kk" value="<?php echo htmlentities($row_guru['Kode_kk'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">Nama_guru:</td>
              <td><input type="text" name="Nama_guru" value="<?php echo htmlentities($row_guru['Nama_guru'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">NIP:</td>
              <td><input type="text" name="NIP" value="<?php echo htmlentities($row_guru['NIP'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">Alamat_guru:</td>
              <td><input type="text" name="Alamat_guru" value="<?php echo htmlentities($row_guru['Alamat_guru'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">Telp_guru:</td>
              <td><input type="text" name="Telp_guru" value="<?php echo htmlentities($row_guru['Telp_guru'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">&nbsp;</td>
          ...
          <input type="hidden" name="Kode_guru" value="<?php echo $row_guru['Kode_guru']; ?>" />
        </div>
        </form>
