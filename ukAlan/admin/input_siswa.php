...
$gambar = $_FILES['Foto_siswa']['name'];
  ...
  $insertSQL = sprintf("INSERT INTO siswa (NISN, Kode_kk, Nama_siswa, Alamat_siswa, Tgl_lahir, Foto_siswa) VALUES (%s, %s, %s, %s, %s, '$gambar')",
...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">INPUT DATA SISWA</div></h1>
          <div align="center"><form action="<?php echo $editFormAction; ?>" method="post" id="form1" enctype="multipart/form-data" name="form1">
            <table border="23" align="center" cellpadding="5" cellspacing="5">
              ...
              <tr valign="baseline">
                ...
                <td><input type="file" name="Foto_siswa" value="" size="32" /></td>
