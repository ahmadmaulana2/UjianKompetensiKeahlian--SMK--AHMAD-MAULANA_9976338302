...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE nilai SET Kode_guru=%s, Kode_sk=%s, Nilai_angka=%s, Nilai_huruf=%s WHERE NISN=%s",
                       GetSQLValueString($_POST['Kode_guru'], "char"),
                       GetSQLValueString($_POST['Kode_sk'], "char"),
                       GetSQLValueString($_POST['Nilai_angka'], "text"),
...
$colname_nilai = "-1";
if (isset($_GET['NISN'])) {
  $colname_nilai = $_GET['NISN'];
}
mysql_select_db($database_koneksi, $koneksi);
$query_nilai = sprintf("SELECT * FROM nilai WHERE NISN = %s", GetSQLValueString($colname_nilai, "char"));
...
<li><a class="MenuBarHorizontal" href="#">Input</a>
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        ...
        <h1><div align="center">EDIT DATA NILAI</div></h1>
        <div align="center"><form action="<?php echo $editFormAction; ?>" method="post" id="form1" enctype="multipart/form-data" name="form1">
          <table border="23" align="center" cellpadding="5" cellspacing="5">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="Kode_guru" value="<?php echo htmlentities($row_nilai['Kode_guru'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right"><strong>Kode SK :</strong></td>
              <td><input type="text" name="Kode_sk" value="<?php echo htmlentities($row_nilai['Kode_sk'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right"><strong>Nilai Angka :</strong></td>
              <td><input type="text" name="Nilai_angka" value="<?php echo htmlentities($row_nilai['Nilai_angka'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right"><strong>Nilai Huruf :</strong></td>
              <td><input type="text" name="Nilai_huruf" value="<?php echo htmlentities($row_nilai['Nilai_huruf'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
              <td align="right">&nbsp;</td>
          ...
          <input type="hidden" name="NISN" value="<?php echo $row_nilai['NISN']; ?>" />
          </div>
        </form>
